...
contract GuardianTest is Test {
    ...
    function test_RegisterGoogleOnly() public {
        ...
        (address storedEOA, bytes32 storedPwHash, bytes32 storedSalt, uint8 storedMode) = 
            guardian.records(EMAIL_HASH);
